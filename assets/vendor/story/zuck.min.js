                ...
                g = {
                    ...
                    template: {
                        ...
                        viewerItemBody: function (t, e, n) {
                            ...
                            .concat(
                                "video" === i(n, "type")
                                ? '<video class="media storyvideo"   webkit-playsinline playsinline preload="auto" src="'
                                .concat(i(n, "src"), '" ')
                    ...
                    language: {
                        unmute: "<img src='/assets/images/mute.png' width='30' class='storyvideosesbtn' ses='kapali' >",
                        ...
                        (k.onplay = function () {
                            ...
                            $(".storyvideosesbtn").click(function(){
                                ...
                                else if( ses=="acik")
                                {
                                    ...
                                    $(".storyvideosesbtn").each(function(){
                                        $(this).attr('src', "assets/images/volume.png");
                                    });
